...
def crear_tablero(sonido_acierto,sonido_error):
    '''
    Crea una lista de tarjetas
    Recibe como parametro los sonidos de error o de acierto especificos
    Retorna un dict tablero
    '''
    tablero = {}
    tablero["tarjetas"] = generar_lista_tarjetas()
    tablero["tiempo_ultimo_destape"] = 0
    tablero["sonido_acierto"] = sonido_acierto
    tablero["sonido_error"] = sonido_error
...
def generar_lista_tarjetas()->list:
    ...
    El for x me recorre todas las posiciones de x usando de step el alto de la tarjeta
    ...
    if(tablero["tiempo_ultimo_destape"] > 0):
        ...
        if retorno != None:
            if retorno:
                ...
                tablero["sonido_acierto"].play()
            else:
                tablero["sonido_error"].play()
